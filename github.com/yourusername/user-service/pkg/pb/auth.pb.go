...
const file_pkg_pb_auth_proto_rawDesc = "" +
	"\n" +
	"\x11pkg/pb/auth.proto\x12\x04auth\"W\n" +
	...
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05valid\x18\x02 \x01(\bR\x05valid2\xb5\x01\n" +
	"\vAuthService\x125\n" +
	...
	"\rValidateToken\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB2Z0github.com/yourusername/user-service/pkg/pb;authb\x06proto3"
...
var file_pkg_pb_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
